    ...
    <AnimatedSection className="bg-ink px-4 py-16 text-center text-white sm:py-24 md:py-36">
      <div className="mx-auto max-w-3xl">
        ...
        <div className="mt-8 flex flex-col items-stretch justify-center gap-3 sm:mt-10 sm:flex-row sm:flex-wrap sm:items-center">
          <Link
            href="/contact"
            className="font-label inline-flex items-center justify-center rounded-full bg-orange px-7 py-3.5 text-[15px] font-semibold text-white transition hover:bg-orange-soft focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-orange"
          >
